...
class ViewController: UIViewController {
    ...
    let transtions : [String] = ["angular", "bouncer", "bow_tie_horizontal", "burn", "bow_tie_vertical", "butterfly_wave_scrawler", "cannabisleaf", "circle", "circle_crop", "circle_open", "color_distance", "colorphase", "crazy_parametric_fun", "cross_hatch", "cross_wrap", "cross_zoom", "cube", "directional", "directional_wrap", "directional_wipe", "displacement", "doom_screen", "doorway", "dreamy", "dreamy_zoom", "fade", "fade_color", "fade_gray_scale", "film_burn", "flyeye", "glitchdisplace", "glitchmemories", "grid_flip", "heart", "hexagon", "linearblur", "wind", "windowblinds"]
