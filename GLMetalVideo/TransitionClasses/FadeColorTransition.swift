...
final class FadeColorTransition : TransitionRenderer {
    
    var color = PixelPoint(red: 0, green: 0, blue: 0, alpha: 1)
    var colorPhase = 0.4
    
    
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_fade_color")
    }
