...
final class DirectionalTranstion : TransitionRenderer {
    
    var direction = VecPoint(x: 0.0, y: 1.0)
    
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_directional")
    }
