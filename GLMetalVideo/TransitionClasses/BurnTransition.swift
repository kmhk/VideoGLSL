...
final class BurnTransition : TransitionRenderer {
    
    var burn_color : PixelPoint = PixelPoint(red: 0.9, green: 0.4, blue: 0.2, alpha: 1.0); // = vec4(0.,0.,0.,.6)
    
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_burn")
