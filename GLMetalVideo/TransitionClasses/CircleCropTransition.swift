...
final class CircleCropTransition : TransitionRenderer {
    
    var bgcolor : PixelPoint = PixelPoint(red: 0.9, green: 0.4, blue: 0.2, alpha: 1.0); // = vec4(0.,0.,0.,.6)
    var ratio = 0.9
    
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_circle_crop")
