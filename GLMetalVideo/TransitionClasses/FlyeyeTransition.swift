...
final class FlyeyeTransition : TransitionRenderer {
    ...
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_flyeye")
