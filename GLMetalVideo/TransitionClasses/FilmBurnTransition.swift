...
final class FilmBurnTransition : TransitionRenderer {
    
    var Seed = 2.13
    
    
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_film_burn")
    }
