...
final class ButterflyWavesScrawler : TransitionRenderer {
    
    var amplitude = 1.0
    var waes = 30.0
    var colorSeparation = 0.3
    
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_butterfly_wave_scrawler")
