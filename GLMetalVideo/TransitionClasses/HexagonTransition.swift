...
final class HexagonTransition : TransitionRenderer {
    
    var steps = 50
    var horizontalHexagons = 20.0
    
    
    init(asset: AVAsset, asset1: AVAsset) {
        super.init(asset: asset, asset1: asset1, function: "transition_hexagon")
